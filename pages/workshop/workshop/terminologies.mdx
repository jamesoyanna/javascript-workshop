...
#### Function have 2 phases:
 The declaration phase  -  Function is defined and stored in the memory of our computer.
 and the invocation phases - When you eventually call or use the function in your code.

The perenthesis. () denotes that we running the function. Functions are reusable pieces of data.
