...
1. Global Execution Context:
	- The global execution context represents the default context when the JavaScript code is executed.
	- It includes global variables and functions that are accessible throughout the entire program.

Function Execution Context:
- When ever we invoke or call  function , a new function execution context is created.
- It includes local variables, parameters, and the scope chain, which consists of variables from the function's own scope and any outer (enclosing) scopes.
...
#### In programming, you engage in two fundamental activities: 

- Creating or generating  data and 


- Running or performing operations or associated functionality on the data.
---
